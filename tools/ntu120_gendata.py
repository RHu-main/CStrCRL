...
if __name__ == '__main__':
    ...
    parser.add_argument('--part1-path', default='/disk/XhWorks/h2/dataset/NTU_RGB+D_120/nturgbd_skeletons_s001_to_s017/nturgb+d_skeletons/nturgb+d_skeletons/')
    parser.add_argument('--part2-path', default='/disk/XhWorks/h2/dataset/NTU_RGB+D_120/nturgbd_skeletons_s018_to_s032/')
    parser.add_argument('--ignored-sample-path',
                        default='/disk/XhWorks/h2/dataset/NTU_RGB+D_120/NTU_RGBD120_samples_with_missing_skeletons.txt')
    parser.add_argument('--out-folder', default='/disk/XhWorks/h2/skeleton_models/crosSCLR-main/data/NTU120/')
