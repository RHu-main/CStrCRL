...
skeleton_folder = '/disk/XhWorks/h2/dataset/PKUMMD/skeleton_v2/'
label_folder = '/disk/XhWorks/h2/dataset/PKUMMD/label/'
save_path = '/disk/XhWorks/h2/dataset/PKUMMD/skeleton_pku_v2_process/'
