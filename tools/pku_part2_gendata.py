...
def gendata(data_path,
            ...
            benchmark='xview',
            part='eval'):
    training_split_file_folder = '/disk/XhWorks/h2/dataset/PKUMMD/Split/'
    ...
    for filename in os.listdir(data_path):
        if filename in ignored_samples:
            continue
        a_id = int(
            filename[filename.find('A') + 1:filename.find('A') + 4]) #before 4
        n_id = int(
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='/disk/XhWorks/h2/dataset/PKUMMD/skeleton_pku_v2_process')
    parser.add_argument('--out_folder', default='/disk/XhWorks/h2/dataset/PKUMMD/pku_part2')

    parser.add_argument('--ignored_sample_path',
                        default='/disk/XhWorks/h2/dataset/PKUMMD/missing_skeletons_file.txt')
