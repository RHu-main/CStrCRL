...
import random
from net.utils.tgcn import ConvTemporalGraphical,GatedConvTemporalGraphical
...
class Model(nn.Module):
    ...
    def __init__(self, in_channels, hidden_channels, hidden_dim, num_class, graph_args,
        ...
        self.st_gcn_networks = nn.ModuleList((
            st_gated_gcn(in_channels, hidden_channels, kernel_size, 1, residual=False, **kwargs0),
            st_gated_gcn(hidden_channels, hidden_channels, kernel_size, 1, **kwargs),
            st_gated_gcn(hidden_channels, hidden_channels, kernel_size, 1, **kwargs),
            st_gated_gcn(hidden_channels, hidden_channels * 2, kernel_size, 2, **kwargs),
...
class st_gated_gcn(nn.Module):
    ...
    def __init__(self,
        ...
        self.gcn = GatedConvTemporalGraphical(in_channels, out_channels,
                                         kernel_size[1])
